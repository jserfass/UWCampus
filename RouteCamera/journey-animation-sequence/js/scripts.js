...
mapboxgl.accessToken =
  "pk.eyJ1IjoianNlcmZhc3MiLCJhIjoiY2w5eXA5dG5zMDZydDN2cG1zeXduNDF5eiJ9.6-9p8CxqQlWrUIl8gSjmNw";
...
map.on("load", async () => {
  ...
  const trackGeojson = await fetch('/data/rainier.geojson').then((d) =>
    d.json()
  );
  ...
  if (prod) {
    ...
    anchor.download =  '/data/rainier.geojson'};
    anchor.click();
  }
